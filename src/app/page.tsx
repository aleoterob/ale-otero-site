          ...
          <div className="flex flex-row justify-center gap-10 pt-16 flex-wrap sm:flex-wrap md:flex-wrap lg:flex-nowrap xl:flex-nowrap 2xl:flex-nowrap">
            ...
            <div className="flex flex-col font-light">
              ...
              <p className="text-lg pb-4" style={{ lineHeight: "1.300" }}>
                ...
                Additionally, I work with a wide range of technologies,
                including HTML5 (I focus on the use of Flexbox Model), CSS3
                (Tailwind framework and SASS processor included), JavaScript and
                TypeScript, Vue and Angular, jQuery, BootStrap and REST and SOAP
                Consuption, among other technologies. Also, I have 6 years of
                experience with different CMSs, mainly with Wordpress, but also
                with Shopify, Webflow, Wix, Drupal and Joomla. I also would like
                to mention that I have nine years of experience with GIT and GIT
                repositories like GitHub and BitBucket. Currently, I am learning
                React Native, which I hope to master soon.
              </p>
              <p className="text-lg pb-4" style={{ lineHeight: "1.300" }}>
              ...
              <p className="text-lg" style={{ lineHeight: "1.300" }}>
                ...
                clean code with visually impactful designs to build solutions
                that are highly functional, user-friendly and full responsive. I
                pride myself on maintaining clear communication and consistently
